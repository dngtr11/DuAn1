...
public class ViewChatvai extends javax.swing.JFrame {
    ...
    public ViewChatvai() {
        ...
        load();
        if(tblCL.getRowCount()>0){
            tblCL.setRowSelectionInterval(0, 0);
            showF();
        }
    }
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        int id = (int) tblCL.getValueAt(selectedRow, 0); // Lấy ID từ bảng
       ...
       ChatLieu cl = new ChatLieu();
        ...
        String result = clr.updateEntity(cl, id);
...
//            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
  ...
  private void load() {
    mol.setRowCount(0);
    ArrayList<ChatLieu>lst = clr.getALL(); // Sử dụng biến lst toàn cục
    ...
    if (lst != null) {
        for (ChatLieu cl : lst) {
            mol.addRow(new Object[]{
                ...
                cl.getMaCl(),
                cl.getTenCL(),
                cl.isTrangThai() ? "Đang hoạt động" : "Đã ngừng"
            });
        }
    } else {
  ...
  private void showF(){
    ...
    txtMa.setText(tblCL.getValueAt(index, 1).toString());
    txtTen.setText(tblCL.getValueAt(index, 2).toString());
    cboTT.setSelectedItem(tblCL.getValueAt(index, 3));
   ...
   private boolean checkT(String ma){
    for(int i= 0;i<tblCL.getRowCount()-1;i++){
        if(tblCL.getValueAt(i, 1).toString().equals(ma)){
            return true;
        }
    }
    return false;
}
    private ChatLieu getF(){
      ChatLieu cl = new ChatLieu();
